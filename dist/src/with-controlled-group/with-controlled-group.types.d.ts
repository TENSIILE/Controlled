...
/**@internal */
export type ControlledMutableCacheValues = {
    current: ControlledDefaultValues;
};
/**@internal*/
...
/**@internal */
type ControlledGroupUseModifiedFormReturn<InputFields extends FieldValues> = Omit<UseFormReturn<InputFields>, 'setValue'>;
/**@internal*/
...
/**@internal */
export type UseControlledContextReturn<InputFields extends FieldValues> = (ControlledGroupUseModifiedFormReturn<InputFields> & ControlledGroupUseFormForeignReturn<InputFields>) | null;
/**@internal */
export type ControlledGroupSetValueHandler<InputFields extends FieldValues> = <Name extends Path<InputFields>>(name: Name, value: PathValue<InputFields, Name> | ((prevState: PathValue<InputFields, Name>) => PathValue<InputFields, Name>), options?: Partial<{
...
/**@internal */
export type UseSubscribeArgumentCallback<InputFields extends FieldValues, CustomEventType extends string = EventType> = (subject: WatchSubject<InputFields, CustomEventType> & {
    value?: PathValue<InputFields, Path<InputFields>> | '';
}) => void;
/**@internal */
export type ControlledGroupEmitHandler<InputFields extends FieldValues> = <CustomEventType extends string = EventType>(subject: WatchSubject<InputFields, CustomEventType>) => void;
/**@internal */
...
/**@internal */
export type DifferenceValuesReviverHandler = <InputFields extends FieldValues>(inputFieldName: Path<InputFields>) => void;
/**@internal */
...
/**@internal */
export type HookArgumentAsyncValuesFunction<InputFields extends FieldValues, Key extends keyof InputFields> = (formValues: InputFields, options: HookArgumentAsyncValuesFunctionOptions<InputFields, Key>) => InputFields[Key] | Promise<InputFields[Key]>;
/**@internal */
export type HookArgumentAsyncValues<InputFields extends FieldValues> = {
    [key in keyof Partial<InputFields>]: HookArgumentAsyncValuesFunction<InputFields, key> | Promise<InputFields[key]> | InputFields[key];
};
/**@internal */
